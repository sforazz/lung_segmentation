...
ls = LungSegmentationTraining(input_dir, work_dir, deep_check=True, tl=False)
ls.get_data(root_path='/mnt/sdb/mouse_fibrosis_data/')
ls.preprocessing(new_spacing=(0.2, 0.2, 0.2))
# ls.create_tensors()
# ls.data_split(additional_dataset=['/mnt/sdb/tl_mouse_MA_all/training'])
# ls.run_training()
